    ...
    <nav class="hidden md:flex items-center gap-6 text-sm">
      ...
      <div class="relative" data-dd="wrapper">
        ...
        <div data-dd="menu"
          ...
          @if (Route::has('clientes.create'))
            <a href="{{ route('clientes.create') }}" class="block px-4 py-2 text-gray-300 hover:bg-gray-800/80 hover:text-white">Alta cliente</a>
          @else
            <a href="#" class="block px-4 py-2 text-gray-400 hover:bg-gray-800/80 hover:text-white">Alta cliente</a>
          @endif
        </div>
      </div>
      ...
      <div class="relative" data-dd="wrapper">
        ...
        <div data-dd="menu" class="hidden absolute left-0 mt-2 min-w-[240px] rounded-lg border border-gray-800 bg-[#0b111b] shadow-xl z-50">
          <a href="{{ route('routers.index') }}" class="block px-4 py-2 text-gray-300 hover:bg-gray-800/80 hover:text-white">Routers</a>
          <a href="{{ route('ipv4.index') }}" class="block px-4 py-2 text-gray-300 hover:bg-gray-800/80 hover:text-white">Redes IPV4</a>
          ...
          @endif
          <a href="{{ route('olts.index') }}" class="block px-4 py-2 text-gray-300 hover:bg-gray-800/80 hover:text-white">Cajas NAP</a>
      ...
      @php
        $sections = [
          'Clientes' => [
            ...
            ['label' => 'Alta cliente', 'route' => Route::has('clientes.create') ? route('clientes.create') : '#'],
          ],
          'Tickets' => [
